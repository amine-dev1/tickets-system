...
export default function Login() {
  ...
  const handleGoogleAuth = async () => {
    ...
    if (error) { setError(translateAuthError(error.message)); setGoogleLoading(false); }
  };
        ...
        <div className="relative z-10 w-full max-w-md animate-scale-in">
          ...
          <div className="relative rounded-3xl p-8 sm:p-9
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 py-2.5 mb-5 rounded-xl text-sm font-medium
                         bg-white dark:bg-gray-800/70 border border-gray-200 dark:border-gray-700
                         text-gray-700 dark:text-gray-200 shadow-soft
                         transition-all duration-200 hover:bg-gray-50 dark:hover:bg-gray-800 hover:shadow-soft-md
